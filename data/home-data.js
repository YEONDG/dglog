...
export const projects = [
  {
    ...
    techStack: ['Next.js', 'TypeScript', 'Supabase', 'NextAuth', 'Tailwind CSS'],
    highlights: [
  ...
  },
  {
    ...
    techStack: ['React', 'TypeScript', '@tanstack/query', '@tanstack/virtual', 'PokeAPI'],
    highlights: [
...
export const values = [
  ...
  {
    title: '지속적 학습',
    description: '빠르게 변화하는 웹 기술 생태계에서 끊임없이 새로운 것을 배우고 적용합니다.',
  },
  {
    title: '클린 코드',
