...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '연동근 - 프론트엔드 개발자 포트폴리오 | React, TypeScript, Next.js',
    description: '프론트엔드 개발자 연동근의 포트폴리오 웹사이트입니다. React, TypeScript, Next.js를 활용한 모던 웹 개발 프로젝트와 개발 철학을 소개합니다.',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            'mainEntity': {
              ...
              'jobTitle': '프론트엔드 개발자',
              'url': 'https://dglog.vercel.app',
              'knowsAbout': ['React', 'TypeScript', 'Next.js', 'JavaScript', 'HTML', 'CSS', 'TailwindCSS'],
